...
func (f *fields) GetByColumn(column string) *fieldInfo {
	...
	return f.columns[strings.ToLower(column)]
}
...
checkType:
	...
	case Fielder:
		...
		if fieldType&IsRelField > 0 {
			err = fmt.Errorf("unsupport type custom field, please refer to https://github.com/Ruzung/beego/blob/master/orm/models_fields.go#L24-L42")
			goto end
		}
	default:
		tag = "rel"
